...
const CustomButton = ({
  ...
  return (
    <button
      ...
      type={type}
      name={name}
      className={`flex cursor-pointer items-center justify-center gap-1 rounded-[8px] ${style ? 'px-0 py-0' : 'px-4 py-2'} font-normal bg-black text-[#F4F4F4] ${disabled && "cursor-not-allowed bg-[#cfc7c2]"} ${className}`}
