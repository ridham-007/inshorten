const terms = [
  ...
  },
  {
    ...
    value:
      "The Website and its content are protected by intellectual property laws, including copyright and trademark laws. You may not use any content or marks displayed on the Website without our prior written consent.",
  },
  {
    key: "User Conduct",
    value:
      "You may not use the Website for any unlawful purposes. You may not attempt to gain unauthorized access to the Website, disrupt the Website’s operation, or engage in any behavior that may harm or interfere with the Website or its users.",
  },
  {
    key: "Privacy",
    value: [
      <>
        ...
        <a
          href="https://www.inshorten.com/privacy-policy"
          target="_blank"
          rel="noopener noreferrer"
          className="text-own_blue_color_primary font-medium cursor-pointer"
        >
          Privacy Policy
        </a>{" "}
  ...
  },
  {
    ...
    value:
      "In no event shall we be liable for any damages, including without limitation direct, indirect, incidental, or consequential damages, arising out of or in connection with your use of the Website.",
  },
  {
    key: "Dispute Resolution",
    value:
      "Any disputes arising out of or related to your use of the Website shall be resolved through arbitration in accordance with the rules of the American Arbitration Association.",
  },
  {
    key: "Changes to These Terms and Conditions",
    value:
      "We may update these terms and conditions from time to time. By continuing to use the Website after any such updates, you agree to be bound by the updated terms and conditions.",
  },
  {
    key: "Governing Law",
    value: [
      ...
      <span className="flex gap-[10px]" key={"email"}>
        email:
        <a
          key="email-link"
          className="text-own_blue_color_primary font-medium"
              ...
              <>
                ...
                <ul>
                  {typeof item.value === "string" ? (
                    <p className="text-[16px] p-[5px]">{item.value}</p>
                  ) : (
                    item.value.map((ele, i) => (
                      <li
                        key={`${item?.key}-value-${i}`}
                        className="text-[16px] p-[5px]"
                      >
                        {ele}
                      </li>
                    ))
